...
(
    ...
    integer_ptr  INT4,
    integer INT4 NOT NULL DEFAULT 0,
    big_int_ptr   bigint,
...
--     money     money NOT NULL,
    ...
    var_char character varying(200) NOT NULL DEFAULT '',
    char_ptr character(80),
    char character(80) NOT NULL DEFAULT '',
    text_ptr text,
    ...
    timez time with time zone NOT NULL DEFAULT now()::timetz,
    ...
    --textsearch
    tsvector_ptr text,
    tsvector text NOT NULL DEFAULT '',
...
VALUES (14, 14, 300, 300, 50000, 5000, 1.11, 1.11, 2.22, 2.22, 5.55, 5.55, 11111111.22, 11111111.22, 1, 1, 1,
--         100000, 100000,
        'ABBA', 'ABBA', 'JOHN', 'JOHN', 'Some text', 'Some text',
        'bytea', 'bytea',
        '1999-01-08 13:05:06+01:00', '1999-01-08 13:05:06+01:00', '1999-01-08 04:05:06', '1999-01-08 04:05:06', '1999-01-08', '1999-01-08', '04:05:06 -8:00', '04:05:06 -8:00', '04:05:06', '04:05:06', '3 4:05:06', '3 4:05:06',
        TRUE, FALSE,
        '(2,3)',
        ...
        '{1, 2, 3}', '{1, 2, 3}', '{"breakfast", "consulting"}', '{"breakfast", "consulting"}', '{"{\"a\": 1, \"b\": 2}","{\"a\": 3, \"b\": 4}"}', '{{meeting,lunch},{training,presentation}}', '{{meeting,lunch},{training,presentation}}')
        ,
       (NULL, 14, NULL, 300, NULL, 5000, NULL, 1.11, NULL, 2.22, NULL, 5.55, NULL, 11111111.22, 2, 2, 2,
--         NULL, 100000,
        NULL, 'ABBA', NULL, 'JOHN', NULL, 'Some text',
        NULL, 'bytea',
        NULL, '1999-01-08 13:05:06+01:00', NULL, '1999-01-08 04:05:06', NULL, '1999-01-08', NULL, '04:05:06 -8:00', NULL, '04:05:06', NULL, '3 4:05:06',
        NULL, FALSE,
        NULL,
        ...
        NULL, '{1, 2, 3}', NULL, '{"breakfast", "consulting"}', '{"{\"a\": 1, \"b\": 2}","{\"a\": 3, \"b\": 4}"}', NULL, '{{meeting,lunch},{training,presentation}}')
;
...
DROP TYPE IF EXISTS test_sample.MOOD;
...
VALUES (0, 'Doe', 'Doe', 'Doe', 'Doe','Doe', 'Doe', 'Doe', 'Doe','Doe', 'Doe', 'Doe', 'Doe','Doe', 'Doe', 'Doe', 'Doe');


DROP TYPE IF EXISTS test_sample.Level;
...
DROP TABLE IF EXISTS test_sample.people;
...
INSERT INTO test_sample.people (people_id, people_name, people_height_cm) VALUES
    (1, 'Alfredo', 170),
    (2, 'Bob', null),
    (3, 'Carla', 155);
